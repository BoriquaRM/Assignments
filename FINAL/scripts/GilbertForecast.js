...
let forecastApiURLstring = 'https://api.openweathermap.org/data/2.5/forecast?id=5295903&units=imperial&APPID=a04e508674b6db51e279599363753e7a';
...
/*MISC Elements*/
		...
		document.getElementById("low-1").innerHTML = dayOne.main.temp_min.toFixed(0) + " - ";
		document.getElementById("low-2").innerHTML = dayTwo.main.temp_min.toFixed(0) + " - ";
		document.getElementById("low-3").innerHTML = dayThree.main.temp_min.toFixed(0) + " - ";
		document.getElementById("low-4").innerHTML = dayFour.main.temp_min.toFixed(0) + " - ";
		document.getElementById("low-5").innerHTML = dayFive.main.temp_min.toFixed(0) + " - ";
